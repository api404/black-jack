...
describe('BlackJackGame', () => {
    ...
    const tests: BlackJackGameTest[] = [
            ...
            }},
        {
            ...
            state: {
                playerCards: [Card.fromString('3♦'), Card.fromString('9♥'), Card.fromString('2♣'), Card.fromString('5♣')],
                playerScore: 19,
            ...
            }},
        {
            ...
            cardsOnTheTopOfTheDeck: [Card.fromString('10♥')],
            state: {
                playerCards: [Card.fromString('9♦'), Card.fromString('9♥'), Card.fromString('5♣')],
                playerScore: 23,
                dealerOpenCards: [Card.fromString('6♥')],
                dealerHiddenCard: Card.fromString('10♦'),
                dealerScore: 16,
        ...
        },
        {
            ...
            cardsOnTheTopOfTheDeck: [Card.fromString('3♦'), Card.fromString('7♥'), Card.fromString('5♣')],
            state: {
                playerCards: [Card.fromString('10♦'), Card.fromString('9♥')],
                playerScore: 19,
                dealerOpenCards: [Card.fromString('3♥')],
    ...
    tests.forEach(({cardsOnTheTopOfTheDeck, name, expectedResult, additionalChecks, ...rest}) => {
        it(`${rest.gameStage}: ${name}`, () => {
            ...
            const result = rest.gameStage === 'createNewGame'
